...
# Your legal name
first_name = "Simon"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Kyei"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Gyimah"                # Your last name in quotes Eg: "Last", "Golla"
...
street = ""     #Enter your street name. e.g. 123 Main Street
state = ""      #Enter your state. e.g, New York
zipcode = ""
country = "United States of America"    #Enter your Country
