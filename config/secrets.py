...
username = ""       # Enter your linkedin username or email address in the quotes
password = ""           # Enter your real linkedin password in the quotes
OPENAI_API_KEY = "sk-" #Enter your OpenAI API Key here. the api starts with 'sk'

EMAIL_ACCOUNTS = [                              #Enter the email address you want to track for your job updates
    {
        "username": "", 
        "password": "", 
...
deepseek_model = "deepseek-reasoner"     # Examples: "deepseek-chat", "deepseek-reasoner"
'''
...
llm_api_key=""              # Enter your API key in the quotes, make sure it's valid, if not will result in error. same as openai api key
