...
In this example, the geo_id for Canada is 101174742. USA is 103644278
...
GPT_MODEL_CANDIDATES = [
    "gpt-3.5-turbo",                 # default – almost always works
    "gemini-pro",                    # Google
    "claude-3-haiku-20240307",       # Anthropic lightweight
    "gpt-4o",                        # Only if proxy has a paid key
]
